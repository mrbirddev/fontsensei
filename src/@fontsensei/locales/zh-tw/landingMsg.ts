export default {
  "{tagName} Google fonts": "{tagName} Google 字體",
  "Free {tagValue} font from Google fonts": "免費{tagValue}字型（Google 字體）",
  "Feedback": "反饋",
  "Select": "選擇",
  "Copy": "複製",
  "Copied": "已複製",
  "Embed": "嵌入",
  "Similar fonts": "相似字體",
  "Free fonts similar to": "免費相似字體：",
  "{fontName} similar fonts": "{fontName} 相似字體",
