Font sensei هو مُنتقي خطوط من Google، مُصنَّف حسب أسماء الوسوم.

![screenshot](/screenshot.png)

## الميزات
- وسوم قابلة للقراءة على اليسار لاكتشاف الخطوط بسهولة.
- وسوم للغات اللاتينية لسهولة الاكتشاف.
- وسوم للغات غير اللاتينية، مثل CJK(الصينية واليابانية والكورية)، بلغتها الأصلية المقابلة.

## الاعتمادات
- مصدر الخط => [Google fonts](https://fonts.google.com)
- بيانات وسوم اللاتينية => [Font Library](https://github.com/katydecorah/font-library)
- الشعار => [SyntheOtaku](https://syntheotaku.itch.io/anime-teacher-sprite)
- استخدمه مباشرةً في منشئ مواقع الويب => [Slidde](https://slidde.co)

## عرض بيانات CJK
تحقق من البيانات على الواجهة ->

### [اليابانية (ja)](https://fontsensei.com/ja/tag/lang_ja)
...
### [الصينية المبسطة (zh-cn)](https://fontsensei.com/zh-cn/tag/lang_zh-hans)
...
### [الصينية التقليدية (zh-tw)](https://fontsensei.com/zh-tw/tag/lang_zh-hant)
...
### [الكورية (ko)](https://fontsensei.com/ko/tag/lang_ko)
